...
<html lang="en">
    ...
    <body>
        <table>
            <tr>
                <td colspan="7" style="text-align: center;text-transform:uppercase;">
                    <b>REKAPITULASI SK SANKSI ADMINISTRATIF YANG TELAH DITERBITKAN</b>
                </td>
            </tr>
        </table>
            ...
            <thead>
                <tr>
                    ...
                    <th  rowspan="2" style="border-top:1px solid #333;border-bottom: 1px solid #333;border-right:1px solid #333;word-wrap: break-word;"
                        ...
                        <b>NAMA KEGIATAN USAHA / BIDANG USAHA</b>
                    </th>
                    ...
                    <th rowspan="2" style="border-top:1px solid #333;border-bottom: 1px solid #333;border-right:1px solid #333;word-wrap: break-word;"
                        ...
                        <b>ALASAN DIBERIKAN SANKSI ADMINISTRATIF</b>
                    </th>
                    <th rowspan="2" style="border-top:1px solid #333;border-bottom: 1px solid #333;border-right:1px solid #333;word-wrap: break-word;"
                        align="center" valign="center" width="60">
                        <b>PERINTAH DALAM SANKSI ADMINISTRATIF PAKSAAN PEMERINTAH</b>
                    </th>
                    <th rowspan="2" style="border-top:1px solid #333;border-bottom: 1px solid #333;border-right:1px solid #333;word-wrap: break-word;"
            ...
            <tbody style="border-bottom:1px solid #333;">
                ...
                <tr>
                    ...
                    <td  style="border-top:1px solid #333;border-left: 1px solid #333;border-bottom: 1px solid #333;border-right:1px solid #333;word-wrap: break-word;"
                        ...
                        {{ $value['kegiatanUsaha']['nama_usaha']}}{{$value['status']==1?'* /':' / '}}{{$value['kegiatanUsaha']['sektorKegiatan']['sektor'] }}
                    </td>
                    ...
                    <td  style="border-top:1px solid #333;border-left: 1px solid #333;border-bottom: 1px solid #333;border-right:1px solid #333;word-wrap: break-word;"
                        valign="center" align="center">
                        {{$carbon::parse($value['tanggal_surat'])->locale('id-ID')->translatedFormat('d-m-Y')}}
                    </td>
        ...
        <table>
            <tr>
                <td>Catatan: </td>
                <td>1. * diberikan sanksi tidak berdasarkan hasil pengawasan</td>
            <tr>
        </table>
    </body>
