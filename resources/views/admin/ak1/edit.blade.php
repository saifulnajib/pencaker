...
<div class="mt-4">
    <div class="card">
        <div class="card-header bg-primary bg-opacity-10 text-dark">
            <h4 class="mb-0">Edit Permohonan AK1</h4>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form action="{{ route('ak1.update', $ak1->id) }}" method="POST" enctype="multipart/form-data" id="formPermohonanAK1" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $ak1->nama) }}" required autofocus>
                                    @error('nama')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $ak1->email) }}" required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" value="{{ old('nik', $ak1->nik) }}" maxlength="16" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" name="no_hp" value="{{ old('no_hp', $ak1->no_hp) }}" required>
                                    @error('no_hp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $ak1->tempat_lahir) }}" required>
                                    @error('tempat_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $ak1->tanggal_lahir) }}" required>
                                    @error('tanggal_lahir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror" id="gender" name="gender" required>
                                        ...
                                        <option value="Laki-laki" {{ old('gender', $ak1->gender) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                        <option value="Perempuan" {{ old('gender', $ak1->gender) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tinggi_badan') is-invalid @enderror" id="tinggi_badan" name="tinggi_badan" value="{{ old('tinggi_badan', $ak1->tinggi_badan) }}" required>
                                    @error('tinggi_badan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('berat_badan') is-invalid @enderror" id="berat_badan" name="berat_badan" value="{{ old('berat_badan', $ak1->berat_badan) }}" required>
                                    @error('berat_badan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_disabilitas') is-invalid @enderror" id="id_disabilitas" name="id_disabilitas">
                                        ...
                                        @foreach($disabilitas as $item)
                                            <option value="{{ $item->id }}" {{ old('id_disabilitas', $ak1->id_disabilitas) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_agama') is-invalid @enderror" id="id_agama" name="id_agama" required>
                                        ...
                                        @foreach($agama as $item)
                                            <option value="{{ $item->id }}" {{ old('id_agama', $ak1->id_agama) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_agama')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_status_perkawinan') is-invalid @enderror" id="id_status_perkawinan" name="id_status_perkawinan" required>
                                        ...
                                        @foreach($status_perkawinan as $item)
                                            <option value="{{ $item->id }}" {{ old('id_status_perkawinan', $ak1->id_status_perkawinan) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jumlah_anak') is-invalid @enderror" id="jumlah_anak" name="jumlah_anak" value="{{ old('jumlah_anak', $ak1->jumlah_anak) }}">
                                    @error('jumlah_anak')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('kendaraan') is-invalid @enderror" id="kendaraan" name="kendaraan">
                                        ...
                                        <option value="Tidak Punya" {{ old('kendaraan', $ak1->kendaraan) == 'Tidak Punya' ? 'selected' : '' }}>Tidak Punya</option>
                                        <option value="Roda 2" {{ old('kendaraan', $ak1->kendaraan) == 'Roda 2' ? 'selected' : '' }}>Roda 2</option>
                                        <option value="Roda 4" {{ old('kendaraan', $ak1->kendaraan) == 'Roda 4' ? 'selected' : '' }}>Roda 4</option>
                                    </select>
                                    @error('kendaraan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3">{{ old('alamat', $ak1->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('rt') is-invalid @enderror" id="rt" name="rt" value="{{ old('rt', $ak1->rt) }}" required>
                                    @error('rt')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('rw') is-invalid @enderror" id="rw" name="rw" value="{{ old('rw', $ak1->rw) }}" required>
                                    @error('rw')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_kelurahan') is-invalid @enderror" id="id_kelurahan" name="id_kelurahan" required>
                                        ...
                                        @foreach($kelurahan as $item)
                                            <option value="{{ $item->id }}" {{ old('id_kelurahan', $ak1->id_kelurahan) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_kelurahan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kode_pos') is-invalid @enderror" id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $ak1->kode_pos) }}" required>
                                    @error('kode_pos')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('tempat_tinggal') is-invalid @enderror" id="tempat_tinggal" name="tempat_tinggal" required>
                                        ...
                                        <option value="Sewa" {{ old('tempat_tinggal', $ak1->tempat_tinggal) == 'Sewa' ? 'selected' : '' }}>Sewa</option>
                                        <option value="Milik Sendiri" {{ old('tempat_tinggal', $ak1->tempat_tinggal) == 'Milik Sendiri' ? 'selected' : '' }}>Milik Sendiri</option>
                                        <option value="Menumpang Dengan Keluarga" {{ old('tempat_tinggal', $ak1->tempat_tinggal) == 'Menumpang Dengan Keluarga' ? 'selected' : '' }}>Menumpang Dengan Keluarga</option>
                                    </select>
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_tingkat_pendidikan') is-invalid @enderror" id="id_tingkat_pendidikan" name="id_tingkat_pendidikan" required>
                                        ...
                                        @foreach($tingkat_pendidikan as $item)
                                            <option value="{{ $item->id }}" {{ old('id_tingkat_pendidikan', $ak1->id_tingkat_pendidikan) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('institusi_pendidikan') is-invalid @enderror" id="institusi_pendidikan" name="institusi_pendidikan" value="{{ old('institusi_pendidikan', $ak1->institusi_pendidikan) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jurusan') is-invalid @enderror" id="jurusan" name="jurusan" value="{{ old('jurusan', $ak1->jurusan) }}" required>
                                    @error('jurusan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tahun_lulus') is-invalid @enderror" id="tahun_lulus" name="tahun_lulus" value="{{ old('tahun_lulus', $ak1->tahun_lulus) }}" required>
                                    @error('tahun_lulus')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nilai') is-invalid @enderror" id="nilai" name="nilai" value="{{ old('nilai', $ak1->nilai) }}" required>
                                    @error('nilai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="tab-pane fade" id="minat" role="tabpanel" aria-labelledby="minat-tab">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_kelompok_jabatan') is-invalid @enderror" id="id_kelompok_jabatan" name="id_kelompok_jabatan" required>
                                        ...
                                        @foreach($kelompok_jabatan as $item)
                                            <option value="{{ $item->id }}" {{ old('id_kelompok_jabatan', $ak1->id_kelompok_jabatan) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_sektor_usaha') is-invalid @enderror" id="id_sektor_usaha" name="id_sektor_usaha" required>
                                        ...
                                        @foreach($sektor_usaha as $item)
                                            <option value="{{ $item->id }}" {{ old('id_sektor_usaha', $ak1->id_sektor_usaha) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('jabatan_minat') is-invalid @enderror" id="jabatan_minat" name="jabatan_minat" value="{{ old('jabatan_minat', $ak1->jabatan_minat) }}" required>
                                    @error('jabatan_minat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="lokasi_kerja" id="lokasi_kerja" class="form-select @error('lokasi_kerja') is-invalid @enderror">
                                        ...
                                        <option value="Dalam Negeri" {{ old('lokasi_kerja', $ak1->lokasi_kerja) == 'Dalam Negeri' ? 'selected' : '' }}>Dalam Negeri</option>
                                        <option value="Luar Negeri" {{ old('lokasi_kerja', $ak1->lokasi_kerja) == 'Luar Negeri' ? 'selected' : '' }}>Luar Negeri</option>
                                    </select>
                                    @error('lokasi_kerja')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kota_negara_minat') is-invalid @enderror" id="kota_negara_minat" name="kota_negara_minat" value="{{ old('kota_negara_minat', $ak1->kota_negara_minat) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_besaran_upah') is-invalid @enderror" id="id_besaran_upah" name="id_besaran_upah" required>
                                        ...
                                        @foreach($besaran_upah as $item)
                                            <option value="{{ $item->id }}" {{ old('id_besaran_upah', $ak1->id_besaran_upah) == $item->id ? 'selected' : '' }}> Rp {{ number_format($item->min, 0, ',', '.') }} - Rp {{ number_format($item->max, 0, ',', '.') }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('is_pernah_bekerja') is-invalid @enderror" id="is_pernah_bekerja" name="is_pernah_bekerja" required>
                                        ...
                                        <option value="1" {{ old('is_pernah_bekerja', $ak1->is_pernah_bekerja) == '1' ? 'selected' : '' }}>Ya</option>
                                        <option value="0" {{ old('is_pernah_bekerja', $ak1->is_pernah_bekerja) == '0' ? 'selected' : '' }}>Tidak</option>
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('keterangan_singkat_pengalaman') is-invalid @enderror" id="keterangan_singkat_pengalaman" name="keterangan_singkat_pengalaman" rows="3">{{ old('keterangan_singkat_pengalaman', $ak1->keterangan_singkat_pengalaman) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('file_foto') is-invalid @enderror" id="file_foto" name="file_foto" accept="image/*">
                                    @if($ak1->file_foto)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/'.$ak1->file_foto) }}" alt="Foto saat ini" class="img-thumbnail" style="max-height: 100px;">
                                            <p class="small text-muted">Foto saat ini. Unggah untuk mengubah.</p>
                                        </div>
                                    @endif
                                    @error('file_foto')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('file_ktp') is-invalid @enderror" id="file_ktp" name="file_ktp" accept="image/*,.pdf">
                                    @if($ak1->file_ktp)
                                        <p class="small text-muted mt-2">File KTP sudah diunggah. Unggah untuk mengubah.</p>
                                    @endif
                                    @error('file_ktp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('file_ijazah') is-invalid @enderror" id="file_ijazah" name="file_ijazah" accept=".pdf">
                                    @if($ak1->file_ijazah)
                                        <p class="small text-muted mt-2">File ijazah sudah diunggah. Unggah untuk mengubah.</p>
                                    @endif
                                    @error('file_ijazah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control @error('file_transkrip') is-invalid @enderror" id="file_transkrip" name="file_transkrip" accept=".pdf">
                                    @if($ak1->file_transkrip)
                                        <p class="small text-muted mt-2">File transkrip sudah diunggah. Unggah untuk mengubah.</p>
                                    @endif
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    @if($ak1->file_ak1)
                                        <p class="small text-muted mt-2">File kartu AK1 sudah diunggah. Unggah untuk mengubah.</p>
                                    @endif
                                    @error('file_ak1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input @error('is_active') is-invalid @enderror" id="is_active" name="is_active" value="1" {{ old('is_active', $ak1->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input @error('is_verified') is-invalid @enderror" id="is_verified" name="is_verified" value="1" {{ old('is_verified', $ak1->is_verified) ? 'checked' : '' }}>
